...
const Recipes = (props) => {
    ...
    const val_step = useRef(parseInt(window.localStorage.getItem('step') || '0', 10));
    ...
    const [ingredients, setIngredients] = useState(JSON.parse(window.localStorage.getItem('ingredients') || '[]'));
        ...
        <div
            ...
            <div
                ...
                <time
                    ...
                    {`Prep time: ${(data.prepTime || '').replace(/[^\d]/g, '')} minutes`}
                </time>
                <p>
                    {'-'}
                </p>
                <time
                    ...
                    {`Cook time: ${(data.cookTime || '').replace(/[^\d]/g, '')} minutes`}
                </time>
                <progress
                    max={stepCount}
                    value={step + 1} />
                            ...
                            return (
                                <div
                                    ...
                                    <time
                                        ...
                                        {`${recipeInstruction.timeRequired.replace(/[^\d]/g, '')} minutes`}
                                    </time>
                                    <p>
